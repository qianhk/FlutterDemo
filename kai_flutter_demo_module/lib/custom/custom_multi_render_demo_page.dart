...
//from https://github.com/CarGuo/gsy_flutter_demo/blob/master/lib/widget/custom_multi_render_demo_page.dart
...
class _CustomMultiRenderDemoPageState extends State<CustomMultiRenderDemoPage> {
  ...
  var customLayoutId = <String>["0", "1", "2", "3", "4"];
        ...
        child: new Container(
          ...
          child: CustomMultiChildLayout(
            ...
            delegate: CircleLayoutDelegate(customLayoutId,
                ...
                center: Offset(MediaQuery.of(context).size.width / 2, MediaQuery.of(context).size.width / 2)),
            children: <Widget>[
              for (var item in customLayoutId) LayoutId(id: item, child: ContentItem(item, childSize)),
            ],
          ),
        ),
      ),
